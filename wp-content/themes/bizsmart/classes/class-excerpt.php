...
* Suit Mag: Excerpt
*
* @since BizSmart 1.0.0
*/
if( ! class_exists( 'BizSmart_Excerpt' ) ):

class BizSmart_Excerpt{
...
/**
* Call to BizSmart_Excerpt
*
* @since  1.0.0
* @uses   BizSmart_Excerpt:::get_instance()->excerpt()
* @param  int $length
* @return void
*/
if( ! function_exists( 'bizsmart_excerpt' ) ):

    function bizsmart_excerpt( $length = 55, $echo = true, $more = '', $page_id = false ) {
        $length = apply_filters( 'bizsmart_excerpt_length', $length );
        return BizSmart_Excerpt::get_instance()->excerpt( $length, $echo, $more, $page_id );
    }
endif;