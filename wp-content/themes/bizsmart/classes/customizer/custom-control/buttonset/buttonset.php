<?php
/**
 * Customizer Control: bizsmart-buttonset.
 *
 * @since   1.0.0
 *
...
if ( class_exists( 'WP_Customize_Control' ) ){
	class BizSmart_Customizer_Buttonset_Control extends WP_Customize_Control {
		 ...
		 * @package BizSmart WordPress Theme
		 */
		public $type = 'bizsmart-buttonset';
		...
		protected function content_template() {
			...
			<# } #>
			<div id="input_{{ data.id }}" class="bizsmart-buttonset">
...
BizSmart_Customizer::add_custom_control( array(
    ...
    'class'    => 'BizSmart_Customizer_Buttonset_Control',
