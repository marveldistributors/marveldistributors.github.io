...
* @since 1.0.0
*
* @package BizSmart WordPress
*/

if ( class_exists( 'WP_Customize_Control' ) ) :

    class BizSmart_Customizer_Reset extends WP_Customize_Control {
        ...
        public function scripts(){
            ...
            wp_localize_script( BizSmart_Helper::with_prefix( 'customize-js' ), 'CUSTOMIZERRESET', array(
                'nonce'   => array(
                    'reset' => wp_create_nonce( 'customizer-reset' ),
                ),
                'confirm' => esc_html__( 'This action is not reversible! Are you sure to reset these settings?', 'bizsmart' )
            ));
        }
...
BizSmart_Customizer::add_custom_control( array(
    'type'     => 'bizsmart-reset',
    'class'    => 'BizSmart_Customizer_Reset',
    'sanitize' => false,
