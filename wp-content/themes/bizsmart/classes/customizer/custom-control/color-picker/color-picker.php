...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class BizSmart_Customizer_Color_Control extends WP_Customize_Control {

		public $type = 'bizsmart-color-picker';
		...
		public function enqueue() {
			wp_enqueue_script( 'wp-bizsmart-color-picker' );
			wp_enqueue_style( 'wp-bizsmart-color-picker' );
		}
...
bizsmart_Customizer::add_custom_control( array(
    ...
    'class'    => 'BizSmart_Customizer_Color_Control',
    'sanitize' => array( 'BizSmart_Customizer', 'sanitize_rgba' ),
));