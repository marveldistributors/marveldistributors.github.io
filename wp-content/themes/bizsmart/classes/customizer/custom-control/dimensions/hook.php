...
if( !class_exists( 'BizSmart_Customizer_Dimensions_Integration' ) ){

	class BizSmart_Customizer_Dimensions_Integration extends BizSmart_Customizer{
		...
		public static $type = 'bizsmart-dimensions';

		public static $class = 'BizSmart_Customizer_Dimensions_Control';
		...
		public function start( $instance , $wp_customize ){
			...
			foreach( $instance::$fields[ self::$type ] as $field ){
				...
				if( !isset( $field[ 'dimension' ] ) ){
					$err = esc_html__( 'Missing key "dimension" passed for Dimension Control.', 'bizsmart' );
	...
	new BizSmart_Customizer_Dimensions_Integration();
}
