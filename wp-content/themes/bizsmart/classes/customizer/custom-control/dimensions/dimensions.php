...
class BizSmart_Customizer_Dimensions_Control extends WP_Customize_Control {
	 ...
	 * @package BizSmart WordPress Theme
	 */
	public $type = 'bizsmart-dimensions';
	...
	public function to_json() {
		...
		$this->json['title'] 	= esc_html__( 'Link values together', 'bizsmart' );
	...
	protected function content_template() {
		...
		<ul class="desktop control-wrap active">
	        ...
	        <li class="dimension-wrap">
	            <div class="link-bizsmart-dimensions">
	...
	protected function l10n( $id = false ) {
		$translation_strings = array(
			'desktop_top' 		=> esc_html__( 'Top', 'bizsmart' 	),
			'desktop_right' 	=> esc_html__( 'Right', 'bizsmart' 	),
			'desktop_bottom' 	=> esc_html__( 'Bottom', 'bizsmart' ),
			'desktop_left' 		=> esc_html__( 'Left', 'bizsmart' 	),
			'tablet_top' 		=> esc_html__( 'Top', 'bizsmart' 	),
			'tablet_right' 		=> esc_html__( 'Right', 'bizsmart' 	),
			'tablet_bottom' 	=> esc_html__( 'Bottom', 'bizsmart' ),
			'tablet_left' 		=> esc_html__( 'Left', 'bizsmart' 	),
			'mobile_top' 		=> esc_html__( 'Top', 'bizsmart' 	),
			'mobile_right' 		=> esc_html__( 'Right', 'bizsmart' 	),
			'mobile_bottom' 	=> esc_html__( 'Bottom', 'bizsmart' ),
			'mobile_left' 		=> esc_html__( 'Left', 'bizsmart' 	),
		);
		if ( false === $id ) {
