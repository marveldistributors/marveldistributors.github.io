 ...
 */
if( !class_exists( 'BizSmart_Customizer_Slider_Integration' ) ){
	class BizSmart_Customizer_Slider_Integration extends BizSmart_Customizer{
		 ...
		 * @package BizSmart WordPress Theme
		 */
		public static $type = 'bizsmart-slider';

		public static $class = 'BizSmart_Customizer_Slider_Control';
	...
	new BizSmart_Customizer_Slider_Integration();
}