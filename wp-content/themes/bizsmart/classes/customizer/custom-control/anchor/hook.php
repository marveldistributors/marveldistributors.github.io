...
if( !class_exists( 'BizSmart_Customizer_Anchor_Integration' ) ){
	class BizSmart_Customizer_Anchor_Integration extends BizSmart_Customizer{

		public static $type  = 'bizsmart-anchor';
		public static $class = 'BizSmart_Anchor_Customize_Section';
	...
	new BizSmart_Customizer_Anchor_Integration();
}