...
class BizSmart_Customizer_Loader extends BizSmart_Helper{
	...
	public static function script(){
		...
		wp_localize_script( self::with_prefix( 'customize-js' ), 'bizsmartColorPalette',
			array( 
				'colorPalettes' => array(
					'#000000',
					'#ffffff',
...
new BizSmart_Customizer_Loader();
