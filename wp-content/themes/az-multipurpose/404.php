...
<div class="row">
    <div class="col-md-6 col-sm-7">
        <div class="page-heading">
            <h2><?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'az-multipurpose' ); ?></h2>
        </div>
    </div>
	<?php
    ...
    <div class="container">
			...
			<div class="row flex-row-reverse">
                ...
                <article id="post-<?php the_ID(); ?>"
                         class="post  status-publish has-post-thumbnail hentry" >

                    <div class="single-post not">
                        <div class="single-post-text">
                    <h1 class="not-founds"><?php esc_html_e( '404 NOT Found!!!', 'az-multipurpose' ); ?></h1><p class="notpage"><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'az-multipurpose' ); ?></p>
		            <div class="searchc">
                        <?php get_search_form();?>
                    </div>
                    </div>
