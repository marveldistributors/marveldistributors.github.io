<div class="rt-team-box-wrapper <?php echo esc_attr( $settings[ 'general_layout' ] ); ?>">
	<div class="rt-team-box-inner">
		...
		<div class="rt-team-content">
			<h3 class="rt-team-name"><?php echo $settings[ 'team_name' ]; ?></h3>
			<h4 class="rt-team-designation"><?php echo $settings[ 'team_designation' ]; ?></h4>
			<p class="rt-team-description"><?php echo $settings[ 'team_description' ]; ?></p>
					...
					<?php foreach( $settings[ 'team_social' ] as $key => $item ): ?>
						...
						<?php
							...
							if( !empty( $button[ 'url' ] ) ){
								...
								echo '<li><a ' . $base->get_render_attribute_string( $name )  . ' ' . $nofollow . '><i class="'. $item[ 'team_social_icon' ]. '"></i></a></li>';
							}
