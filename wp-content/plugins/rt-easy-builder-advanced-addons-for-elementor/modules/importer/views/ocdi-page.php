						...
						<div class="ocdi__gl-item-footer<?php echo ! empty( $import_file['preview_url'] ) ? '  ocdi__gl-item-footer--with-preview' : ''; ?>">
							...
							<div class="rt-builder-btn-wrapper">
								...
								<?php
									if( rt_freemius()->is_not_paying() && $import_file[ 'pro' ] ){
										...
										?>
										<a href="//riseblocks.com/rt-easy-builder/pricing/" target="_blank" class="ocdi__gl-item-button  button  button-primary buy-link">
							...
							<div class="demo-requirement">
								...
								<div class="required-theme">
									<?php esc_html_e( 'Theme:', 'rise-builder' ); ?> <a href="<?php echo esc_url( $import_file[ 'theme' ][ 'link' ] ); ?>" target="_blank"><?php echo $import_file[ 'theme' ][ 'name' ]; ?></a>
								</div>
