<div class="rt-builder-landing">
	<div class="rt-builder-landing-header">
		...
		<a href="//riseblocks.com/rt-easy-builder/pricing/" target="_blank" class="rt-builder-landing-btn">
	...
	<div class="rt-builder-landing-banner">
		...
		<div class="rt-builder-landing-btn-wrap">
			<a href="//riseblocks.com/rt-easy-builder/starter-templates/" target="_blank" class="rt-builder-landing-btn"><?php esc_html_e( 'Starter Sites', 'rise-builder' ); ?> <span class="dashicons dashicons-welcome-view-site"></span></a>
		...
		<div class="rt-builder-landing-box">
			<div class="rt-builder-landing-box-inner">
				...
				<div>
					...
					<a href="//riseblocks.com/rt-easy-builder/" target="_blank"><?php esc_html_e( 'Documentation', 'rise-builder' ); ?> </a>
				</div> 
			</div>
		</div>
		<div class="rt-builder-landing-box">
			<div class="rt-builder-landing-box-inner">
				...
				<div>
					...
					<a href="//riseblocks.com/rt-easy-builder/products/" target="_blank"><?php esc_html_e( 'Widgets', 'rise-builder' ); ?> </a>
				</div> 
			</div>
		</div>
		...
		<div class="rt-builder-landing-box">
			<div class="rt-builder-landing-box-inner">
				...
				<div>
					...
					<a href="//riseblocks.com/rt-easy-builder/contact/" target="_blank"><?php esc_html_e( 'Support', 'rise-builder' ); ?></a>
				</div> 
			</div>
		</div>
		<div class="rt-builder-landing-box">
			<div class="rt-builder-landing-box-inner">
				...
				<div>
					...
					<a href="//wpactivethemes.com/" target="_blank"><?php esc_html_e( 'Themes', 'rise-builder' ); ?></a>
				</div> 
			</div>
		</div>
		<div class="rt-builder-landing-box">
			<div class="rt-builder-landing-box-inner">
				...
				<div>
					...
					<a href="//riseblocks.com/rt-easy-builder/starter-templates/" target="_blank"><?php esc_html_e( 'Demo Templates', 'rise-builder' ); ?></a>
				</div> 
			</div>
		</div>
		<div class="rt-builder-landing-box">
			<div class="rt-builder-landing-box-inner">
				...
				<div>
					...
					<a href="#" target="_blank"><?php esc_html_e( 'Rating', 'rise-builder' ); ?></a>
				</div> 
			</div>
		</div>
	</div>
	...
	<div class="rt-builder-landing-pro-notice">
		<div>
			...
			<div class="rt-builder-landing-btn-wrap">
				<a href="//riseblocks.com/rt-easy-builder/pricing/" target="_blank" class="rt-builder-landing-btn"><?php esc_html_e( 'Free vs Pro', 'rise-builder' ); ?> <span class="dashicons dashicons-shortcode"></span></a>
				<a href="//riseblocks.com/rt-easy-builder/pricing/" target="_blank" class="rt-builder-landing-btn rt-btn-secondary"><?php esc_html_e( 'Go to Pro', 'rise-builder' ); ?> <span class="dashicons dashicons-plugins-checked"></span></a>
			</div>
		</div>
	</div>
</div>
